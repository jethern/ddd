...
#
# The following samples are for adding the 099 prefix, used by the
# Nextel carrier in Brazil. It also adds the area code (43) if missing.
# Examples:
# 1234-5678       -> (099 43) 1234-5678
# (43) 1234-5678  -> (099 43) 1234-5678
# 443 is DDD from my hometown(Londrina)
patterns = [
        ...
        # NNNN-NNNN -> (43) NNNN-NNNN
        # Numbers with no area code. Add the (43) prefix.
        ('^(\d{4}-\d{4})$', r'(43) \1'),
        ...
        # (AA) NNNN-NNNN -> (099 AA) NNNN-NNNN
        # Numbers with area code, but no carrier code (099)
        ('^\((\d{2})\) (\d{4}-\d{4})$', r'(099 \1) \2'),
        ...
        #
        # # Change carrier, from Claro (21) to Nextel (41)
        # # (021 AA) NNNN-NNNN -> (099 AA) NNNN-NNNN
        # ('^\(021 ', r'(099 '),
        #
        ...
        # # +55AANNNNNNNN -> (099 AA) NNNN-NNNN
        # ('^\+55(\d{2})(\d{4})(\d{4})$', r'(099 \1) \2-\3'),
        #
